...
const LongWhiteBox = ({title,description,category,upvotes,comments,linkFurther,id}) => {
    ...
    return (
        ...
        <div className={LongWhiteBoxStyles.LongWhiteBox}
            onClick={linkFurther ? linkFurtherHandler : null }
            style={ linkFurther ? { cursor: "pointer"} : {}}
        >
